  ...
  <div className="flex flex-wrap items-center">
    ...
    <h2 className="mb-3 line-clamp-3 capitalize hover:line-clamp-none text-2xl font-extrabold tracking-wide leading-none text-white md:text-3xl lg:text-4xl dark:text-white">
      ...
      <div className="w-full mb-2">
        ...
        <i class="fas fa-signal mr-2 text-gray-200">
      </i>             
           {courseDetails.level}</p>
        </div>
...
{courseDetails.price}</p>
        </div>

        <div className="flex flex-row items-center mb-1">
        
        <p className="text-gray-400 text-md font-mono font-thin">
        <i class="fas fa-chalkboard-teacher mr-2 text-gray-200">
      </i>
          {courseDetails.instructor_first_name} {courseDetails.instructor_last_name}</p>
        </div>
      ...
      <div className="container mx-auto mt-4 mb-4">
        ...
        <div className="container p-3 flex items-center justify-between">
          ...
          <h3 className="text-xl text-gray-900 font-semibold">
            {loading ? (''):(
              <><span className="text-[19px]"><i class="far fa-clock mr-2">
              </i></span>
              <span className="text-xl text-[18px] font-mono">{courseDetails.duration}</span>
              </>
        ...
        <div className="container mx-auto mt-4 mb-4">
          {loading ? (
            ...
            courseDetails.modules.map((module) => (
              ...
              >
                <div className="flex items-center">
                <span className="mr-4"><BiLock size={20} color="black" /></span>
              ...
              <div>
                {loading ? (
                  ...
                  <>
                    ...
                    {courseDetails.instructor_skill}</span>
