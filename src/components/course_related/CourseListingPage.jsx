    ...
    <div className="w-full md:w-3/4 px-4 mt-5 mb-5">
      ...
      <div className="relative container min-h-[200px] rounded-md mb-4">
        ...
        <div className="absolute left-0 top-0 bottom-0 p-4 text-white">
          ...
          <h2 className="text-2xl font-bold text-green-500">Overlay Text</h2>
...
<div class="flex-shrink-0 bg-white border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 rounded-md hover:bg-blue-100">
  <img src="https://daisyui.com/images/stock/photo-1507358522600-9f71e620c44e.jpg" alt="Image Alt Text" class="w-full rounded-t-md object-top" />
  <div class="p-4">
    <p>20m</p>
    <h3 class="text-xl font-bold mb-2 dark:text-white tracking-tight text-gray-900 ">The Ultimate Guide to Chess: learn chess</h3>
    {/* <p class="text-gray-600 mb-4">Description of Course 1.</p> */}
    <p className='mb-3 font-normal text-gray-700 dark:text-gray-400'>Fadil ameen</p>
  </div>
</div>
