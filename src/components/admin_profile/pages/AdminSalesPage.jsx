        ...
        <div className="h-screen w-full bg-gray-200 p-4 overflow-y-auto">
          ...
          <div className="relative container bg-gray-900 min-h-[150px] rounded-md mb-4">
            ...
            <div className="absolute left-0 top-0 bottom-0 p-4 text-white">
              ...
              <h1 class="mb-3 text-3xl font-extrabold leading-none tracking-tight capitalize text-white md:text-3xl lg:text-4xl dark:text-white">Sales <span class="underline underline-offset-3 decoration-8 decoration-green-400 dark:decoration-blue-600">management.</span></h1>
  
  <p class="text-sm font-normal capitalize text-gray-200 lg:text-lg">Manage sales of skill savant.</p>
            </div>
