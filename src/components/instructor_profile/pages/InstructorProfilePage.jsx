        ...
        <div className="h-screen w-full bg-gray-200 p-4 overflow-y-auto">
          ...
          <div className="relative container bg-blue-700 min-h-[170px] rounded-md mb-4">
            ...
            <div className="absolute left-0 top-0 bottom-0 p-4 text-white">
              ...
              <h1 class="mb-4 text-2xl capitalize font-extrabold leading-none tracking-tight text-white md:text-3xl lg:text-4xl dark:text-white">Elevate your teaching <span class="underline underline-offset-3 decoration-8 decoration-green-400 dark:decoration-blue-600">experience with Skill Savant.</span></h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-white rounded shadow-lg">
               ...
               {userProfile ? (
                    ...
                    <div>
                    <p className="text-md font-bold ml-3"> {userProfile && `${userProfile.first_name} ${userProfile.last_name}` }</p>
                  ...
                  <div class="p-4">
                      <div class="flex justify-between items-center">
                          <div class="flex items-start justify-center space-x-1">
                              ...
                              <div class="">
                          <h1 class="text-white text-2xl font-bold">Skill Savant Wallet</h1>
                      </div>

                            
                          </div>
                          
                          <div class="card-chip w-8 h-8">
                      ...
                      <div class="mt-4">
                          ...
                          <p class="text-white text-xl font-semibold tracking-wider">&times;&times;&times;&times; &times;&times;&times;&times; 2030 3020</p>
                      </div>
                      <div class="mt-4">
                          <p class="text-gray-400 text-xs">Balance</p>
                          <p class="text-white text-xl font-semibold tracking-wider">&#8377;{userProfile?.wallet}</p>
                      </div>
                      <div class="flex justify-between mt-4">
                          <div>
                              <p class="text-gray-400 text-xs">Card Holder</p>
                              <p class="text-white text-sm">{userProfile && `${userProfile.first_name}` }</p>
                          </div>
                          <div>
