  ...
  return (
    <>
      ...
      <div className="container mx-auto p-4 mt-4 flex">
        ...
        <LearningPageMobileSideBar setCurrentModule={setCurrentModule} courseData={courseData} loading={loading} currentModule={currentModule}/>
          {/* sidebar */}
      
          {/* ReactPlayer Component (replace with your ReactPlayer code) */}

          <LearningReactPlayer setCourseData={setCourseData} currentModule={currentModule} loading={loading} />
    ...
    <div className="flex items-center">
      <div className="bg-gray-200 h-4 w-6 rounded-md"></div>
                    ...
                    courseData.modules.map((module) => (
                        ...
                        {`${currentModule.id === module.id ? ('bg-blue-100'):('hover:bg-blue-50 transition  duration-150 ease-in-out')}
                        ...
                        cursor-pointer
                          ...
                          `}>
                            <div class="flex items-center" onClick={() => setCurrentModule(module)}>
                                {module.is_completed ? (
                                  <i class="fas fa-check-circle text-green-500 mr-4"></i>
                                ):(
                                  <i class="fas fa-check-circle text-gray-200 mr-4"></i>
                                )}
                                <span class="font-medium text-gray-800">{module.module_order}. {module.module_title}</span>
                            </div>
                            <div class="flex items-center">
                                {/* <i class="far fa-file-alt text-gray-500 mr-2"></i> */}
                                <span class="text-sm text-gray-600">{module.duration}m</span>
                            </div>
                        </li>
                    ))
                )}
