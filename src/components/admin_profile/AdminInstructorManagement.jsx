      ...
      <caption className="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
        ...
        <label for="table-search" class="sr-only">Search</label>
          <div class="relative mt-1">
              ...
              <input type="text" id="table-search" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-md w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for items"/>
          </div>
      </caption>
      ...
      <tbody>
        ...
        {instructors ? (
            ...
            instructors.map((instructor)=>(
                <tr key={instructor.user.id} className="bg-white dark:bg-gray-800">
          <th
            scope="row"
          ...
          <td className="px-6 py-4">{instructor.user.last_name}</td>
          <td className="px-6 py-4">{instructor.user.email}</td>
          <td className="px-6 py-4">
          <button type="button" class="text-white bg-gradient-to-r from-green-400
