  ...
  <div className="container mx-auto mt-4">
    <div className="container mb-4 p-3">
      ...
      <p className="text-gray-700 mt-2">
        Nullam varius, ipsum sit amet tristique vehicula, massa libero feugiat
        justo, at bibendum ipsum sem sed justo. Nulla facilisi. Proin tristique
        vehicula orci, eu bibendum sapien posuere non.
      </p>
    </div>
    <hr />
  </div>
        ...
        <div>
          {
            loading ? (
             ...
             <>
              <h3 className="text-xl font-semibold">{courseDetails.instructor_first_name} {courseDetails.instructor_last_name}</h3>
          <p className="text-gray-700">{courseDetails.instructor_skill}</p></>
            )
          }
        </div>
      </div>
