...
import { Home, LoginPage, SignupPage } from "./../components/home/index";
  ...
  return (
    <Routes>
      ...
      <Route
        path="/profile"
        element={
          <PrivateRoute element={<StudenProfilePage />} roles={["student"]} />
        }
      ></Route>
      ...
      <Route
        ...
        element={
          <PrivateRoute element={<EnrollmentPage />} roles={["student"]} />
        }
      ></Route>
      ...
      <Route
        ...
        element={
          <PrivateRoute element={<CourseLearningPage />} roles={["student"]} />
        }
      ></Route>
      ...
      <Route
        path="/MyLearning"
        element={
          <PrivateRoute element={<MylearningPage />} roles={["student"]} />
        }
      ></Route>
