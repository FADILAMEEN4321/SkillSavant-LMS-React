...
const LearningPageMobileSideBar = ({courseData, loading, currentModule, setCurrentModule}) => {
  return (
    <>
  ...
  <div className="drawer-content">
    {/* Page content here */}
    <label htmlFor="my-drawer" className="btn btn-sm mb-2 drawer-button">modules</label>
  </div> 
